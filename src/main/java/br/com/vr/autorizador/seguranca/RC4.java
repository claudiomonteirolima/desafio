package br.com.vr.autorizador.seguranca;
...
public class RC4 {
	...
	*/
    public static byte[] encrypt(String plaintext, SecretKey secretKey, Cipher rc4) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        rc4.init(Cipher.ENCRYPT_MODE, secretKey);
        byte[] plaintextBytes = plaintext.getBytes();
        byte[] ciphertextBytes = rc4.doFinal(plaintextBytes);
        System.out.println("RC4 ciphertext base64 encoded: " + Base64.getEncoder().encode(ciphertextBytes));
        return ciphertextBytes;
    }

    public static void decrypt(SecretKey secretKey, Cipher rc4, byte[] ciphertextBytes) throws InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
